    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <b class="titleHeader">TB Screening Detail</b>  <c:if test="${canEdit && patient.status.name=='Active'}">| <a href="${page}/patient/tb-screening/item.form?patientId=${patient.id}">Add TB Screening </a></c:if>
                            <hr/>
                                ...
                                <table class="itemList" class="display" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Date Screened</th>
                                            <th>Identified with TB Symptoms</th>
                                            <th>TB Symptoms Identified</th>
