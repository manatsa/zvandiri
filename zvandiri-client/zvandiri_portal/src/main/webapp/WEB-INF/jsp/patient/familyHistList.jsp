        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6"><a style="text-align: right;"
                                             href="${page}/beneficiary/socialhist/item.list?id=${patient.id}">Next To
                        Social History &DoubleRightArrow;</a></div>
                </div>
                <br/>
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <c:if test="${family == null}">
                            <c:if test="${canEdit}"><a
                                    href="${page}/beneficiary/familyhist/item.form?patientId=${patient.id}">Add Family
                                History </a></c:if>
                        </c:if>
                    </div>
                </div>
