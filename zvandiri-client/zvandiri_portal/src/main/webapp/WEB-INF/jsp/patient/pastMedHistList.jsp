        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6"><a href="${page}/beneficiary/srh/item.list?id=${patient.id}">Next To SRH
                        History &DoubleRightArrow;</a></div>
                </div>
                <br/>
                <div class="row">
                    <div class="col-lg-12">
                        <b class="titleHeader">Hospitalisation History</b> <c:if test="${canEdit}">| <a
                            href="item.form?patientId=${patient.id}">Add Hospitalisation History Item </a></c:if>
                        <hr/>
