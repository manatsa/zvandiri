        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6"><a href="${page}/beneficiary/substance/item.list?id=${patient.id}">Next To
                        Substance Use History &DoubleRightArrow;</a></div>
                </div>
                <br/>
                <div class="row">
                    <div class="col-lg-12">
                        <b class="titleHeader">Mental Health Detail</b> <c:if test="${canEdit}">| <a
                            href="${page}/beneficiary/mental-health/item.form?patientId=${patient.id}">Add Mental Health
                        Hist </a></c:if><br/><br/>
