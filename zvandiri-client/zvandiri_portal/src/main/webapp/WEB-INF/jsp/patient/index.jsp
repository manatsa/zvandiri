        ...
        if (num_chars >= 3) {
            ...
            search_url = $.get(path + "/patient/search-children-cats", {search: $this.val()}, function (pat) {
                ...
                for (i = 0; i < pat.length; i++) {
                    ...
                    var tb_screening_url = "<a href='"+path+"/patient/tb-screening/item.form?patientId=" + pat[i].id + "'>";
                    ...
                    $("#patientListing").dataTable().fnAddData([part_url +pat[i].name+ "</a>",
                        ...
                        pat[i].primaryClinic,
                        pat[i].active === true ?
                            contact_url+"Add Contact | </a>"+referral_url+"Referral | </a>"+tb_screening_url+"TB Screening | </a>" + vl_url+"VL/Bleeding </a>" : ""]);
