        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6"><a href="${page}/beneficiary/chronic-infection/item.list?id=${patient.id}">Next
                        To OI History &DoubleRightArrow;</a></div>
                </div>
                <br/>
                <div class="row">
                    <div class="col-lg-12">
                        <br/>
                        <b class="titleHeader">ARV Hist Detail</b> <c:if test="${canEdit}">| <a
                            href="item.form?patientId=${patient.id}">Add ARV Hist Item </a></c:if>
                        <hr/>
                            ...
                            <table class="itemList" class="display" cellspacing="0">
                                ...
                                <c:forEach var="arvHist" items="${arvHists}">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="${page}/patient/arv-adverse-effects/item.list?id=${arvHist.id}">Adverse
                                                Effects</a> |
