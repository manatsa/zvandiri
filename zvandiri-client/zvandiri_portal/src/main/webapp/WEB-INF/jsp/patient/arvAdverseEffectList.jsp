        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <br/>
                        <b class="titleHeader">${item.arvMedicine.name} : Adverse Effects</b> <c:if test="${canEdit}">|
                        <a href="item.form?arvHistId=${item.id}">Add ${item.arvMedicine.name} : Adverse Effect
                            Item </a></c:if>
                        <hr/>
