        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6"><a href="${page}/beneficiary/arv-hist/item.list?id=${patient.id}">Next To ARV
                        Use History &DoubleRightArrow;</a></div>
                </div>
                <br/>
                <div class="row">
                    <div class="col-lg-12">
                        <b class="titleHeader">Substance Use Detail</b> <c:if test="${canEdit}">| <a
                            href="${page}/beneficiary/substance/item.form?patientId=${patient.id}">Add Substance Use
                        Hist </a></c:if>
                        <hr/>
