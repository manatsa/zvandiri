                ...
                <div class="row">
                    <div class="col-lg-10">
                        <form:form commandName="item">
                            ...
                            <div class="form-group">
                                <label>Current Primary Clinic : </label>${item.patient.primaryClinic.name}
                            </div>
                            <div class="form-group">
                                <label>Region</label>
                            ...
                            <div class="form-group">
                                ...
                                <form:select path="patient.district" id="district" class="form-control">
                                    <form:option value="" label="--Select Item"/>
                            ...
                            <div class="form-group">
                                ...
                                <form:select path="patient.primaryClinic" id="primaryClinic" class="form-control">
                                    <form:option value="" label="--Select Item"/>
                                    <form:options items="${facilities}" itemValue="id" itemLabel="name"/>
                                </form:select>
                                <p class="help-block">
                                    <form:errors path="patient.primaryClinic" class="alert-danger"/>
                                </p>
                            </div>
                            <div class="form-group">
                                <c:if test="${canEdit}">
