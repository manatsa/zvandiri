 ...
 */
@Component
public class HospCauseValidator implements Validator {
    ...
    public boolean supports(Class<?> type) {
        return type.equals(HospCause.class);
    }
    ...
    public void validate(Object o, Errors errors) {
         ...
         */
        HospCause current = (HospCause) o;
        HospCause old = null;
        if (current.getId() != null) {
            old = hospCauseService.get(current.getId());
        }
        if (hospCauseService.checkDuplicate(current, old)) {
