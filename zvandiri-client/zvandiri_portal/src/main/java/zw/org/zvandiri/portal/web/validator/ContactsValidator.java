...
public class ContactsValidator implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        if (item.getLocation() != null &&
                (item.getLocation().getId().equalsIgnoreCase("2ac6420c-52b0-40f7-b1d3-9499d4119b47")
                        || item.getLocation().getId().equals("f8556945-06a1-469e-bec0-e722c807cec9"))) {
            ValidationUtils.rejectIfEmpty(errors, "supportGroupTheme", "field.empty");
        }
