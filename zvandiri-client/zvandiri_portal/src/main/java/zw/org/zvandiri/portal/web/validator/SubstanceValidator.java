 ...
 */
@Component
public class SubstanceValidator implements Validator {
    ...
    public boolean supports(Class<?> type) {
        return type.equals(Substance.class);
    }
    ...
    public void validate(Object o, Errors errors) {
         ...
         */
        Substance current = (Substance) o;
        Substance old = null;
        if (current.getId() != null) {
            old = substanceService.get(current.getId());
        }
        if (substanceService.checkDuplicate(current, old)) {
