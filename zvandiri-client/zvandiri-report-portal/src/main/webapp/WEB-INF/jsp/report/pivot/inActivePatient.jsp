    ...
    <div id="page-wrapper"><br/>
        ...
        <form:form commandName="item" role="form">
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            <label>Start Date (Date Left Program)</label>
                    ...
                    <td>
                        <div class="form-group">
                            <label>End Date (Date Left Program)</label>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $.get(path + "/report/pivot/patient/getinactivepatient", searchParams, function (mps) {
                    $("#output").pivotUI(mps, {
                        renderers: renderers,
