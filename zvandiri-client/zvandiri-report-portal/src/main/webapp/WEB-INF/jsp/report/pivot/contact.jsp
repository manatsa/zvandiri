    ...
    <div id="page-wrapper"><br/>
        ...
        <form:form commandName="item" role="form">
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            <label>Start Date (Contact Date)</label>
                    ...
                    <td>
                        <div class="form-group">
                            <label>End Date (Contact Date)</label>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $.get(path + "/report/pivot/contact/getcontact", searchParams, function (mps) {
                    $("#output").pivotUI(mps, {
                        renderers: renderers,
                        cols: ["Age Group"], rows: ["Month"],
