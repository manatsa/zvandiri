 ...
 */
@Component
public class EnhancedValidator implements Validator {
    ...
    public boolean supports(Class<?> type) {
        return type.equals(Enhanced.class);
    }
    ...
    public void validate(Object o, Errors errors) {
         ...
         */
        Enhanced current = (Enhanced) o;
        Enhanced old = null;
        if (current.getId() != null) {
            old = enhancedService.get(current.getId());
        }
        if (enhancedService.checkDuplicate(current, old)) {
